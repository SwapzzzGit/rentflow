                ...
                <>
                    <div className="flex items-start justify-between gap-4 flex-wrap mb-4">
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 flex-wrap mb-2">
                                <span className="w-2.5 h-2.5 rounded-full flex-shrink-0" style={{ background: priorityColor[ticket.priority] || 'var(--dash-muted)' }} />
                            ...
                            {ticket.description && <p className="text-sm mb-4" style={{ color: 'var(--dash-muted)' }}>{ticket.description}</p>}
                        </div>
                    </div>
                    {/* Info strip */}
                    <div className="flex flex-wrap gap-4 text-xs" style={{ color: 'var(--dash-muted)' }}>
                        {[
                            ...
                            <div key={label}>
                                <p className="font-semibold uppercase tracking-wider mb-0.5" style={{ fontSize: 10 }}>{label}</p>
                                <p style={{ color: 'var(--dash-text)' }}>{value}</p>
                            </div>
                        ))}
                    </div>
                </>
