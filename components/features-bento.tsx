    ...
    <section id="features" className="px-6 py-20 md:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 md:grid-cols-5 md:grid-rows-2">
          ...
          <div className="feature-card reveal-blur stagger-1 rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[rgba(255,255,255,0.03)] p-6 md:col-span-3">
            ...
            <p className="mb-5 text-sm leading-[1.65] text-[#666666]">
          ...
          <div className="feature-card reveal-blur stagger-2 rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[rgba(255,255,255,0.03)] p-6 md:col-span-2 md:row-span-2">
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[#E8392A]/15">
          ...
          <div className="feature-card reveal-blur stagger-3 rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[rgba(255,255,255,0.03)] p-6">
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[#E8392A]/15">
              <BarChart3 className="h-5 w-5 text-[#E8392A]" />
            </div>
            <h3 className="mb-2 text-xl font-semibold text-[#ffffff]">Expense Tracker</h3>
            <p className="text-sm leading-[1.65] text-[#666666]">
          ...
          <div className="feature-card reveal-blur stagger-4 rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[rgba(255,255,255,0.03)] p-6">
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[#E8392A]/15">
          ...
          <div className="feature-card reveal-blur stagger-1 rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[rgba(255,255,255,0.03)] p-6">
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[#E8392A]/15">
